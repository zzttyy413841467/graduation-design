...
% CL = exp(cl0*speed)+cl1*aoa+cl2;
% CD = exp(cd0*speed)+cd1*aoa.^2+cd2;
...
balance=L.*cbank-(gravity-speed.^2./rad);

phaseout.dynamics  = [altdot, londot, latdot, speeddot, fpadot, azidot];
phaseout.path = [dynamic_pressure, n, qdot,balance];
phaseout.integrand = 0.8*fpadot.^2+qdot;